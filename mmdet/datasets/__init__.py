...
from .UCAS import UCASDataset
from .DIOR import DIORDataset
from .DIOR_COCO import DIORDataset_COCO
...
__all__ = [
    ...
    'CustomSampleSizeSampler', 'Flickr30kDataset', 'NWPUDataset','RSODDataset', 'UCASDataset', 'DIORDataset',
    'DIORDataset_COCO'
]
