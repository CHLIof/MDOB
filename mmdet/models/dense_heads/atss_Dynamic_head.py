...
class DynamicModule(BaseModel):
    ...
    def forward(self, visual_feats: Tuple[Tensor],
        ...
        for i, feature in enumerate(visual_feats):
            ...
            cls_logits.append(self.cls_logits(visual))
...
class ATSSDynamicHead(ATSSHead):
    ...
    def __init__(self,
                 *args,
                 ...
                 num_classes=80,
                 **kwargs):
        super().__init__(num_classes=num_classes, *args, **kwargs, init_cfg=init_cfg)
        self.head = DynamicModule(
    ...
    #         # exit(0)
    #         ncls = cls_score.size(1)
    #         cls_scores_.append(cls_score.permute(0, 2, 3, 1).reshape(bs, -1, ncls))
    #         # print(cls_scores_[0].shape)
    #         # exit(0)
    #
    #     cls_scores = torch.cat(cls_scores_, dim=1)
    #     # print(cls_scores.shape)
    #     # exit(0)
    #     # print(cls_scores.shape)
    #     # exit(0)
    ...
    #
    #     # print(num_valid_anchors)
    #     # exit(0)
    #     # print(sampling_result)
    #     # print("self.reg_decoded_bbox: ", self.reg_decoded_bbox)
    ...
    #         # exit(0)
    #
    #         cls_logit = cls_logit.permute(1, 2,
