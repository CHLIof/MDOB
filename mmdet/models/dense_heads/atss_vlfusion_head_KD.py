...
class VLFusionModule(BaseModel):
    ...
    def forward(self, visual_feats: Tuple[Tensor],
        ...
        for i, feature in enumerate(visual_feats):
            ...
            #
            #
            # print(dot_product_proj_tokens_bias.size())
            # print(bias.size())
            #
            # print(self.num_base_priors)
            #
            # exit(0)
...
class ATSSVLFusionHead_KD(ATSSHead):
    ...
    def loss(self, visual_feats: Tuple[Tensor], language_feats: dict,
        ...
        cls_logits, bbox_preds, centerness, visual_list = self(visual_feats, language_feats)
