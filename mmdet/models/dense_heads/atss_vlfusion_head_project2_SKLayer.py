...
class VLFusionModule(BaseModel):
    ...
    def _init_layers(self) -> None:
        ...
        for dataset_index in range(self.dataset_quantity):
            ...
            #               kernel_size=(1, 1)))
            self.image_feature_projection.append(SKLayer(self.in_channels))
...
class ATSSVLFusionHeadProject2SKLayer(ATSSHead):
    ...
    Args:
        ...
        图像特征在进行dyhead前进行映射(使用SKlayer进行特征映射)，语言特征在进行点积前进行映射，语言特征的映射为双线性层映射
    """
