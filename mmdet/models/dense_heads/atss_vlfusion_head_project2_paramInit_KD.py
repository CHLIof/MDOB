...
class VLFusionModule(BaseModel):
    ...
    def forward(self, visual_feats: Tuple[Tensor],
        ...
        # torch.save(dot_product_proj_tokens, "RSOD_project.pt")
        # exit(0)
        ...
        return bbox_preds, centerness, cls_logits, visual_list


@MODELS.register_module()
class ATSSVLFusionHeadProject2ParamInit_KD(ATSSHead):
    ...
    Args:
        ...
        图像特征在进行dyhead前进行映射，语言特征在进行点积前进行映射，语言特征的映射为双线性层映射, 进行参数初始化
    """
    ...
    def forward(self, visual_feats: Tuple[Tensor],
        ...
        """Forward function."""
        bbox_preds, centerness, cls_logits, visual_list = self.head(visual_feats,
                                                       language_feats, datasetnum_list)
        return cls_logits, bbox_preds, centerness, visual_list
    ...
    def loss(self, visual_feats: Tuple[Tensor], language_feats: dict,
        ...
        cls_logits, bbox_preds, centerness, visual_list = self(visual_feats, language_feats, datasetnum_list)
