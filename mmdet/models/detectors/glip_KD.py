...
class GLIP_KD(SingleStageDetector):
    ...
    def __init__(self,
        ...
        pth_path = r"/home/ly/workspace/unifymodel/mmdet/model/glip_tiny_a_mmdet-b3654169.pth"

        self.teacher.load_state_dict(torch.load(pth_path), strict=False)
        self.teacher.eval()

        self.KDLoss = PKDLoss(loss_weight=6.0, resize_stu=False)
        self.L1Loss = L1Loss(loss_weight=6.0)
    ...
    def loss(self, batch_inputs: Tensor,
        ...
        # print("language_dict_features.size: ", language_dict_features.size())
        # exit(0)
        ...
        if int(self.epoch) <= 5:
            ...
            _, visual_list_teacher = self.teacher.bbox_head.loss(visual_features, language_dict_features,
                                                      batch_data_samples)
