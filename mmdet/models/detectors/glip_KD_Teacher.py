...
class GLIP_KDTeacher(SingleStageDetector):
    ...
    def loss(self, batch_inputs: Tensor,
        ...
        print(visual_features[1].shape)
        print(visual_features[2].shape)
        print(visual_features[3].shape)
        print(visual_features[4].shape)
        exit(0)
