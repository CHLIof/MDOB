...
class GLIP_ParamInit_KD_changeBackbone(SingleStageDetector):
    ...
    def __init__(self,
        ...
        # print(backbone)
        # del(backbone['convert_weights'])
        # del (backbone['init_cfg'])

        # print(backbone)
        # print(neck)
        # exit(0)

        backbone_teacher = {'type': 'SwinTransformer',
                            'embed_dims': 96,
                            'depths': [2, 2, 6, 2],
                            'num_heads': [3, 6, 12, 24],
                            'window_size': 7,
                            ...
                            #              'checkpoint': r'/home/ly/workspace/unifymodel/mmdet/model/swin_tiny_patch4_window7_224.pth'},
                            }
        # print(type(backbone))
        # print(type(backbone_teacher))
        # exit(0)

        # backbone_teacher = backbone
        # exit(0)
        # backbone_teacher['init_cfg'] = {}
        # backbone_teacher['init_cfg']['type'] = 'Pretrained'
        # backbone_teacher['init_cfg']['checkpoint'] = r'/home/ly/workspace/unifymodel/mmdet/model/swin_tiny_patch4_window7_224.pth'

        neck_teacher = {'type': 'FPN_DropBlock',
        ...
        self.teacher = GLIP(backbone_teacher, neck_teacher, bbox_head, language_model, train_cfg, test_cfg, data_preprocessor, init_cfg)

        pth_path = r"/home/newspace/ly/workspace/mmdet/output/exp_test36/epoch_36.pth"
        ...
        # self.teacher._load_from_state_dict(torch.load(pth_path))

        # unexpected_keys = []
        # all_missing_keys = []
        # err_msg = []

        # self.teacher._load_from_state_dict(torch.load(pth_path), '', {}, True,
        #                              all_missing_keys, unexpected_keys,
        #                              err_msg)
        #
        # print(all_missing_keys)
    ...
    def loss(self, batch_inputs: Tensor,
        ...
        # print(self.language_model.state_dict().keys())
        # print(self.language_model.state_dict()['language_backbone.body.model.embeddings.word_embeddings.weight'])
        # print(self.language_model.state_dict()['language_backbone.body.model.encoder.layer.0.intermediate.dense.weight'])
        # print(self.language_model.language_backbone.body.model.encoder.layer[0])
        # exit(0)
        # print(self.backbone.state_dict().keys())
        # print(self.backbone.state_dict()['stages.3.blocks.1.ffn.layers.1.weight'])
        # exit(0)

        # print(self.bbox_head.state_dict().keys())
        # print(self.bbox_head.state_dict()['head.dyhead_tower.0.dyconvs.0.conv.weight'])
        # print(self.bbox_head.named_parameters()['head.dyhead_tower.0.dyconvs.0.conv.weight'])
        # exit(0)
        # for name, param in self.language_model.named_parameters():
        #     if name == 'language_backbone.body.model.encoder.layer.0.intermediate.dense.weight':
        #         print(param)
        #         break
        ...
        # visual_features = self.teacher.extract_feat(batch_inputs)
        #
        # losses = self.teacher.bbox_head.loss(visual_features, language_dict_features,
        #                              batch_data_samples)
        ...
        # loss_head_feature = loss_head_feature / num_feature

        # 语言特征蒸馏
        # print(language_dict_features['embedded'].shape)
        # print(language_dict_features['embedded'].unsqueeze(0).shape)
        # exit(0)
        # loss_language = self.L1Loss(language_dict_features['embedded'].unsqueeze(0), language_dict_features_teacher['embedded'].unsqueeze(0))
    ...
    def predict(self,
        ...
        if isinstance(text_prompts[0], list):
            ...
            # language_dict_features = self.teacher.language_model(list(text_prompts))
