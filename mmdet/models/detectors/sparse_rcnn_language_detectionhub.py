...
class SparseRCNNLanguageDetectionHub(TwoStageDetector):
    ...
    def loss(self, batch_inputs: Tensor,
        ...
        if self.with_rpn:
            ...
            rpn_losses, rpn_results_list = self.rpn_head.loss_and_predict(
                x, rpn_data_samples, language_dict_features=language_dict_features, proposal_cfg=proposal_cfg)
    ...
    def predict(self,
        ...
        if batch_data_samples[0].get('proposals', None) is None:
            rpn_results_list = self.rpn_head.predict(
                x, batch_data_samples, language_dict_features=language_dict_features,rescale=False)
        else:
            rpn_results_list = [
                data_sample.proposals for data_sample in batch_data_samples
            ]
