...
class SparseRoIHeadLanguageDetectionHub(CascadeRoIHead):
    ...
    def bbox_loss(self, stage: int, x: Tuple[Tensor],
        ...
        """
        # print("results_list len: ", len(results_list))
        ...
        bbox_results = self._bbox_forward(stage, x, rois, object_feats,
                                          batch_img_metas, language_dict_features, label_positives)
        imgs_whwh = torch.cat(
    ...
    def _bbox_forward(self, stage: int, x: Tuple[Tensor], rois: Tensor,
        ...
        cls_score, bbox_pred, object_feats, attn_feats = bbox_head(
            bbox_feats, object_feats, language_dict_features, label_positives)
    ...
    def loss(self, x: Tuple[Tensor], rpn_results_list: InstanceList,
             batch_data_samples: SampleList, language_dict_features) -> dict:
        ...
        for i, data_samples in enumerate(batch_data_samples):
            # print(data_samples.gt_instances.positive_maps)
            # print(data_samples.label_positive)
            label_positives.append(data_samples.label_positive)
    ...
    def predict_bbox(self,
        ...
        num_classes = len(batch_img_metas[0]['text'])
        # print(num_classes)
