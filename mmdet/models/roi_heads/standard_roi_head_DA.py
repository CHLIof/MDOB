...
class StandardRoIHeadDA(BaseRoIHead):
    ...
    def loss(self, x: Tuple[Tensor], rpn_results_list: InstanceList,
        ...
        # print(batch_data_samples[0].dataset_num)
        # batch_data_samples[0].test = 0
        # print(batch_data_samples)
        # exit(0)
        # print(x.shape)
        # print(len(x))
        ...
        for i in range(num_imgs):
            ...
            sampling_result.dataset_num = batch_data_samples[i].dataset_num
    ...
    def _bbox_forward(self, x: Tuple[Tensor], rois: Tensor, dataset_list: List) -> dict:
        ...
        # print(self.bbox_roi_extractor.num_inputs)
        ...
        cls_score, bbox_pred = self.bbox_head(bbox_feats, dataset_list, feat_batch)
    ...
    def bbox_loss(self, x: Tuple[Tensor],
        ...
        # print("x at bbox_loss: ", len(x))
        # exit(0)


        rois = bbox2roi([res.priors for res in sampling_results])

        dataset_list = [sr.dataset_num for sr in sampling_results]

        # print(dataset_list)
        # exit(0)

        bbox_results = self._bbox_forward(x, rois, dataset_list)
    ...
    def predict_bbox(self,
        ...
        dataset_list = [bim['dataset_num'] for bim in batch_img_metas]
