...
class DetLocalVisualizer(Visualizer):
    ...
    def add_datasample(
        ...
        # print(type(self.dataset_meta))
        # print(self.dataset_meta)
        # print(name)
        # print(data_sample)
        dataset_num = data_sample.dataset_num
        # print(dataset_num)

        # print(pred_score_thr)
        # exit(0)

        # self.dataset_meta = self.dataset_meta[dataset_num]
        # exit(0)

        # classes = self.dataset_meta.get('classes', None)
        # palette = self.dataset_meta.get('palette', None)
        classes = self.dataset_meta[dataset_num].get('classes', None)
        palette = self.dataset_meta[dataset_num].get('palette', None)
